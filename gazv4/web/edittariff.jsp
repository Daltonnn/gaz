            ...
            <form method="post" action="EditTariff" >
                ...
                <div class="form-row">
                    <div class="form-group col-md-6">
                        ...
                        <input type="text" name="cena_sta" value="<% out.print(taryfa.getTariff(cos).getCenaLicz());  %>" class="form-control"   pattern="\d+(\.\d{2})?" required>
                    </div>                
                </div>
                <div class="form-row">
                    <div class="form-group col-md-6">
                        <label for="inputSurname">Cena za m<SUP>3</SUP></label>
                        <input type="text" name="cena_jed" value="<% out.print(taryfa.getTariff(cos).getCenaJed());  %>" class="form-control" pattern="\d+(\.\d{2})?" required>
                    </div>
                </div>            
